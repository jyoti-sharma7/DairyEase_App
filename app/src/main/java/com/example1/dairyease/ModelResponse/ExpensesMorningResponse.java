...
public class ExpensesMorningResponse {
    ...
    public static class ExpensesMorningList {
        ...
        public ExpensesMorningList(Integer id, Integer user_id, String date, String product, String shift, Integer quantity, String unit, String per_quantity, Integer total_price, String created_at, String updated_at) {
            this.id = id;
